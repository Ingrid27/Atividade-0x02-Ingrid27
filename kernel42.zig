...
fn kmain() void {
    terminal.initialize();
    terminal.write("Hello Richard, Kernel World from Zig 0.7.1!");
    terminal.write(" :) ");
    terminal.turn_leds_on();
}
...
const terminal = struct {
    ...
    var color = vga_entry_color(VGA_COLOR_LIGHT_RED, VGA_COLOR_BLACK);
